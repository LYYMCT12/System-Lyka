...
<body class="cm-login">
    ...
    <div class="text-center" style="padding:55px 0 45px 0;background:#fff;border-bottom:5px solid #ddd;">
        <h1 class="text-primary text-center text-uppercase">{{ \Session::get('app.title') }}</h1>
